    ...
    <DefaultLayout>
      ...
      <main>
        <div className="mx-auto mt-7 max-w-6xl px-7 sm:px-6 lg:mt-16 lg:px-8 text-justify">
          <h1 className="text-3xl lg:mb-4 lg:text-[2.5rem] font-medium">
            Privacy Policy
          </h1>
          <br />
          ...
          We use the information we collect solely to respond to your inquiries
          and provide you with the information or services you request.
